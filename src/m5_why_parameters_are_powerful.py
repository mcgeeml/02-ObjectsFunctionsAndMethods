...
def main():
    ...
    #better_draw_circles(rg.Point(10, 90), 10)

    #even_better_draw_circles(rg.Point(0,0), 6, 10, 'blue', 6)
    #even_better_draw_circles(rg.Point(100, 50), 9, 11, 'green', 10)
...
def even_better_draw_circles(point, radii, num, color, thick):
